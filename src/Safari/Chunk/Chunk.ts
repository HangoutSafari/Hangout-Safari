...
export class Chunk extends THREE.Object3D
{
    ...
    public constructor(index: number,position:SafariVector, width: number = 500)
    {
        ...
        this.randomAnimalPosition = new THREE.Vector3(position.x + generateNumber(100), 40, position.z + generateNumber(100)); //new THREE.Vector3(this.position.x * generateNumber(width), 0, this.position.z * generateNumber(width));
