...
const Register = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<body><div class="flex p-5 justify-center self-center text-center items-center z-30"><div class="bg-white p-5 rounded shadow-2xl w-72 md:w-96"><h2 class="text-2xl font-semibold text-gray-500 mb-4">REGISTER</h2>
