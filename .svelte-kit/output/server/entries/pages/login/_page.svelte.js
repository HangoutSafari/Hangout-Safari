...
/* empty css                                                    */const Login = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div class="flex p-5 justify-center self-center text-center items-center z-30"><div class="bg-white p-5 rounded shadow-2xl w-72 md:w-96"><h2 class="text-2xl font-semibold text-gray-500 mb-4">LOG IN</h2>
      <form><div class="mb-4"><i class="fa-regular fa-envelope absolute text-center mt-3 px-1 border-orange-300 border-r-2 text-gray-400"></i>
        ...
        <div class="mb-4"><i class="fa-solid fa-key absolute text-center mt-3 px-1 border-orange-300 border-r-2 text-gray-400"></i>
          ...
          ${`<hr class="border-2 rounded border-orange-400">`}
          ${``}</div></form>
        <button id="3" type="submit" class="w-full h-10 bg-gray-300 font-bold text-gray-500 py-2 rounded-md hover:text-black hover:bg-gradient-to-r from-[#F34439] to-[#FF8D07]">SUBMIT</button>
      ...
      <button type="submit" class="w-full h-10 bg-gray-300 font-bold text-gray-500 py-2 rounded-md hover:text-black hover:bg-gradient-to-r from-[#F34439] to-[#FF8D07]">Register</button></div></div>`;
});
