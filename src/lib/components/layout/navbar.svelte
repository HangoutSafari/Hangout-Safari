...
<body class="background">
  <nav class="mt-2 bg-transparent ">
    ...
    >
    <div  class="logo-container md:block hidden ">
      ...
      <div class="flex items-center space-x-4">
        <div class={$page.url.pathname == '/events'}>
            <a href="/events"
        ...
        <div class="md:order-3 order-2">
          <div class={$page.url.pathname == '/profile'}>
            <a href="/profile " 
        ...
        <div class="md:order-2 order-3">
         <div class={$page.url.pathname == '/safari'}>
            <a href="/safari"
              class="active font-semibold  shadow-lg px-8 py-4 bg-white text-black rounded hover:bg-gray-300"
            >
              Safari
            </a>
          </div> 
