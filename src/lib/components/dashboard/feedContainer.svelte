...
<div class="bg-white drop-shadow-lg p-4 sm:rounded-b-2xl">

  <div>
      {#each { length: 6 } as _, i}
        <Feed 
        profileImage = "/images/customer.jpg"
        animalImage = "images/bunny.png"
        dateObtained = "1-12-2023"
        locationObtained = "Art Fair"
        />
      {/each}
  </div>
</div>
