...
const Navbar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<nav class="backdrop-blur pt-2"><div class="flex md:justify-between justify-center"><div class="logo-container md:block hidden ml-8 "><a href="/" class="flex items-center"><img src="/images/logo.jpg" alt="Logo" class="rounded-full object-cover w-20 h-20">
    ...
    "font-semibold order-1 px-3 py-4 pt-5 background text-black rounded md:mr-1 hover:px-4 hover:py-5 duration-300 ease-in-out hover:text-white hover:bg-gradient-to-r from-[#F34439] to-[#FF8D07] hover:drop-shadow-lg svelte-30mzwn",
...
<div class="h-full"><div class="z-50 sm:sticky top-0 bg-white-500"></div>

  <div class="background h-full"><div class="z-[51] sticky top-0 bg-white-500">${validate_component(Navbar, "Navbar").$$render($$result, {}, {}, {})}</div>
