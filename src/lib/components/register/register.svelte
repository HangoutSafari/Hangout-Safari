  ...
  export function handleInputKeydown(e, index) {
    ...
    if (e.key === "ArrowUp" || e.key === "ArrowDown") {
      ...
      if (e.key === "ArrowUp") {
        ...
        nextIndex =
          currentIndex < focusableInputs.length - 1
            ? currentIndex + 1
            : currentIndex;
      }
...
<div class=" flex p-5 justify-center self-center text-center items-center z-30">
  <div class="bg-white p-5 rounded shadow-2xl w-72 md:w-96">
    ...
    <form on:submit|preventDefault={register}>
      <div class="mb-4">
        <i
          class="fa-regular fa-user absolute text-center mt-3 px-1 border-orange-300 border-r-2 text-gray-400"
        />
        <input
