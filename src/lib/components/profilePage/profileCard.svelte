<div
  class="relative safari-bg flex lg:w-[25rem] lg:h-[22rem] drop-shadow-2xl p-0 m-0"
>
  ...
  >
    <img
      class=" w-[70%] lg:h-[15rem] lg:w-[15rem] mt-1 rounded-full mx-auto lg:mt-[-1rem] mb-5"
    ...
    <p
      class="font-bold text-[2rem] lg:text-[1rem] mt-7 lg:mt-2 mb-3 lg:mb-auto"
    >
      Animal count: 1245
    </p>
