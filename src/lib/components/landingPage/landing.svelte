...
<div style="relative hidden md:block ">
    <div class="z-2 mt-5 relative logo-container md:block hidden ml-8 lg:flex lg:flex-col lg:items-center" style="position: absolute; z-index: 1;">
...
<div class=" grid absolite z md:grid-cols-2 grid-cols-1 md:pt-0 mt-0 md:mt-[-35px] lg:mt-[-70px] pt-5 background">
    ...
    <div class="md:ml-16 md:order-1 ml-5 mr-5 mt-0 md:mt[-7px] ">
        ...
        <hr class="border border-t-4 my-7 border-gray-400 w-[90%] rounded mx-auto md:mx-0" />
