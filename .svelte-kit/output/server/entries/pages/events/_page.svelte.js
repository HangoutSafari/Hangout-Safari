...
const Sidebar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<main class="font-sans bg-[#F2F2F2]">
    <aside class="sm:fixed bg-[#D9D9D9] text-gray-200 sm:h-full lg:flex flex-col drop-shadow-lg w-full sm:w-80">
      ...
      <label for="search" class="hidden lg:flex mx-5 my-3 sm:m-5 h-8 bg-[#BBBBBB] items-center rounded-xl focus-within:border-4 border-sky-400/30"><i class="fas fa-search mx-2"></i>
        <input type="text" id="search" placeholder="Search..." class="outline-none border-none bg-transparent placeholder-gray-200"></label>
  
      
      <ul class="pl-5 m-2 lg:m-0 sm:pl-0 flex overflow-x-auto gap-4 flex-row sm:flex-col sm:items-center sm:space-y-7 sm:gap-0">${validate_component(Category, "Category").$$render($$result, { icon: "fas fa-futbol", text: "Sports" }, {}, {})}
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.data === void 0 && $$bindings.data && data !== void 0)
    $$bindings.data(data);
  return `<main class="bg-[#e7e4e4]"><div class="z-[51] sticky top-0">${validate_component(Sidebar, "SideNavBar").$$render($$result, {}, {}, {})}</div>
