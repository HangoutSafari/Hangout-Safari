...
const AnimalCard = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="inline-block"><div class="flex flex-col bg-gray-200 items-center content-center h-[14rem] lg:h-auto lg:w-[15rem] rounded-xl p-3 gap-1 font-Jaldi drop-shadow-lg"><div class="flex items-center content-center gap-3"><p class="font-bold drop-shadow-md text-white text-[2rem] lg:text-2xl">Joe</p>
      <img class="w-[1rem] lg:w-[12px] lg:h-[12px]" src="/images/edit.png" alt=""></div>
    <img class="h-[5rem] lg:h-auto" src="/images/bunny.png" alt="">
    <div class="flex flex-col gap-0 items-center"><p class="mb-0 pb-0 font-bold text-[1rem] lg:text-base">Achieved from:</p>
      <p class="pt-0 mt-0 text-[0.8em] lg:text-base">Art fair</p></div>
    <p class="text-[1rem] lg:text-2xl font-bold inline-block text-transparent bg-clip-text bg-gradient-to-br from-[#C51FFF] to-[#FF00E5]">Epic
    </p></div>
</div>`;
});
...
<div class="rounded-2xl lg:rounded-none relative safari-bg flex w-full h-[10rem] lg:w-[25rem] lg:h-[22rem] drop-shadow-2xl p-0 m-0 bg-white lg:bg-transparent"><div class="absolute inset-0 overflow-hidden rounded-xl"><img class="hidden lg:block w-full h-full object-cover object-center blur-[8px] brightness-75" src="/images/profileBg.png" alt="Safari Background"></div>
  <div class="w-full z-10 lg:text-white mt-5 justify-self-center mx-5 text-[1.6rem] lg:text-2xl"><div class="flow-root"><h1 class="float-left font-bold">Anti-aliasing</h1>
      <input id="aA" class="hidden peer" type="checkbox"${add_attribute("this", checkbox1, 0)}>
      <label id="label" for="aA" class="float-right w-[1rem] h-[1rem] lg:w-auto p-2 font-medium tracking-tight lg:h-2 cursor-pointer bg-brand-light text-brand-black border-black lg:border-white border-[3px] peer-checked:border-gray-100 lg:peer-checked:bg-black"><i class="" style="color: #ffffff;"${add_attribute("this", icon1, 0)}></i></label></div>
    <hr class="my-5">
    <div class="flow-root"><h1 class="float-left font-bold">Allow rotation</h1>
      ...
      <label id="label" for="aR" class="float-right w-[1rem] h-[1rem] lg:w-auto p-2 font-medium tracking-tight lg:h-2 cursor-pointer bg-brand-light text-brand-black border-black lg:border-white border-[3px] peer-checked:border-gray-100 lg:peer-checked:bg-black"><i class="" style="color: #ffffff;"${add_attribute("this", icon2, 0)}></i></label></div></div></div>`;
});
...
<div class="w-full"><div class="mt-5 grid grid-cols-1 lg:grid-cols-3 justify-items-center text-2xl gap-y-4"><p class="font-bold hidden lg:block">Profile</p>
  ...
  <div class="grid grid-cols-3 place-items-center mt-5 text-[1.5rem] lg:text-[3rem] lg:hidden py-5"><p${add_attribute("this", settings, 0)}>Settings</p>
    <p${add_attribute("this", animals, 0)}>Animals</p>
    <p${add_attribute("this", information, 0)}>Information</p></div>

  ${`<div class="flex justify-center py-10 lg:hidden"><div class="w-[95%]">${validate_component(SettingsCard, "SettingsCard").$$render($$result, {}, {}, {})}</div></div>`}
  ${``}
  ${``}
