import type * as THREE from "three";
    ...
    export class LightProperties{
         ...
         */
        constructor(light: THREE.Light, lColor: THREE.Color, lStrength: number, isCastingShadows: boolean = true){
            //color
         ...
         */
        public moveToPosition(light:THREE.Light, x: number, y:number, z:number) :void
        {
            light.position.set(
                light.position.x + x,
                light.position.y + y,
